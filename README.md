...
## Support ##
For support, please file an issue on the [bwa/0.7.12](https://github.com/lh3/bwa) [Github project](https://github.com/oicr-gsi/smmipsWorkflow) or send an email to gsi@oicr.on.ca .
